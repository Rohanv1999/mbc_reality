            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-lg" name="size" id="size">
                        ...
                        <option value="264x262">@lang('264x262')</option>
                        <option value="264x450">@lang('264x450')</option>
                        <option value="830x220">@lang('830x220')</option>
                        <option value="272x269">@lang('272x269')</option>
                        <option value="272x463">@lang('272x463')</option>
                    </select>
                </div>
