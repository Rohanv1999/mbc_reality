                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" value="{{old('title')}}" class="form-control form-control-lg" placeholder="@lang('Enter Property Title')" maxlength="255" required="">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="phone" name="phone" id="phone" value="{{old('phone')}}" class="form-control form-control-lg" placeholder="@lang('Enter Phone')" maxlength="40" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" id="email" value="{{old('email')}}" class="form-control form-control-lg" placeholder="@lang('Enter Email Address')" maxlength="60" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <input type="text" id="facebook" class="form-control form-control-lg" value="{{old('facebook')}}" placeholder="@lang('Enter Facebook Url')" name="facebook" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <input type="text" id="twitter" value="{{old('twitter')}}" class="form-control form-control-lg" placeholder="@lang('Enter Twitter Url')" name="twitter" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                          <div class="input-group-append">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <input type="text" id="linkedinIn" value="{{old('linkedinIn')}}" class="form-control form-control-lg" placeholder="@lang('Enter LinkedinIn Url')" name="linkedinIn" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                          <div class="input-group-append">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <input type="text" id="instagram"  value="{{old('instagram')}}" class="form-control form-control-lg" placeholder="@lang('Enter Instagram Url')" name="instagram" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                                          <div class="input-group-append">
