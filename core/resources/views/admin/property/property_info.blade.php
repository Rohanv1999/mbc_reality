                ...
                <div class="card-body">
                	<form action="{{route('admin.property.info.update', $property->id)}}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="unit" id="unit" value="{{@$propertyInfo->unit}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Unit')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="left" id="left" value="{{@$propertyInfo->lefts}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Left')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="room" id="room" value="{{@$propertyInfo->room}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Room')" required="">
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="bathroom" id="bathroom" value="{{@$propertyInfo->bathroom}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Bathroom')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="kitchen" id="kitchen" value="{{@$propertyInfo->kitchen}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Kitchen')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="car_parking" id="car_parking" value="{{@$propertyInfo->car_parking}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Car Parkings')" required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="floor" id="car_parking" value="{{@$propertyInfo->floor}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Floor')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-2">
                                             ...
                                             <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="square_feet" id="square_feet" value="{{getAmount(@$propertyInfo->square_feet)}}" class="form-control form-control-lg" placeholder="@lang('Enter Total Square Feet')" required="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                          <input type="text" id="price"  value="{{getAmount(@$propertyInfo->price)}}" class="form-control form-control-lg" placeholder="@lang('Enter Price')" name="price" aria-label="Recipient's username" aria-describedby="basic-addon2" required="">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="available_time" id="available_time" value="{{showDateTime(@$propertyInfo->available_time, 'Y-m-d')}}" data-language="en" class="form-control form-control-lg datepicker-here" placeholder="@lang('Enter Available Time')" required="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row addedField">
                                            @if(!empty($propertyInfo))
                                                @foreach($propertyInfo->propertyOptionalImage as $value)
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                ...
                                <div class="card border--primary mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="row amenitiesField">
                                            @if(!empty($propertyInfo))
                                                @foreach($propertyInfo->propertyAmenities as $proValue)
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <div class="card border--primary mt-2">
                                    <h5 class="card-header bg--primary">@lang('Property Description')</h5>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <textarea rows="10" class="form-control nicEdit" name="description">@php echo @$propertyInfo->description @endphp</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="image-upload">
                        <div class="thumb">
                            <div class="avatar-preview">
                                ...
                                <div class="profilePicPreview" style="background-image: url({{getImage(imagePath()['property']['path'],imagePath()['property']['size'])}})">
                                </div>
                            </div>
                            <div class="avatar-edit">
                                <input type="file" class="profilePicUpload h-0 p-0" name="optional_image[]" id="profilePicUpload${id}" accept=".png, .jpg, .jpeg">
