    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.typeproperty.index')}}">
                    <a href="{{route('admin.typeproperty.index')}}" class="nav-link"
                       data-default-url="{{ route('admin.typeproperty.index') }}">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.property*',3)}}">
                        ...
                        <span class="menu-title">@lang('Manage Property') </span>
                        @if(0 < $pending_property_count)
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.property*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.property.pending')}} ">
                                <a href="{{route('admin.property.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending')</span>
                                    @if($pending_property_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_property_count}}</span>
                                    @endif
                                </a>
                            </li>

                             <li class="sidebar-menu-item {{menuActive('admin.property.approved')}} ">
                                <a href="{{route('admin.property.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved')</span>
                                </a>
                            </li>

                             <li class="sidebar-menu-item {{menuActive('admin.property.cancel')}} ">
                                <a href="{{route('admin.property.cancel')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
