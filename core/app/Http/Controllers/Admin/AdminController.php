...
class AdminController extends Controller
{
    ...
    {
        $pageTitle = 'Dashboard';
        $properties = Property::orderBy('id', 'DESC')->with('location', 'city', 'propertyInfo')->limit(8)->get();
        $property['all'] = Property::count();
        $property['pending'] = Property::where('status', 0)->count();
        $property['approved'] = Property::where('status', 1)->count();
        $property['cancel'] = Property::where('status', 2)->count();
        $propertyType = PropertyType::count();
        $city = City::count();
        $location = Location::count();
        $ads = Advertisement::count();
        return view('admin.dashboard', compact('pageTitle', 'propertyType', 'city', 'location', 'ads', 'property', 'properties'));
    }
