...
<body>
        ...
        <div class="ad-auth-box">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form class="formget" action="<?php echo base_url('register/registered')?>" method="POST" id="reg_form">
                        <a href="<?=base_url();?>" class="ad-auth-logo">
                            ...
                            <div class="register_type">
                                <h6><?php echo $this->lang->line('ltr_select_usertype');?>:</h6>
                                <div class="ad-other-feilds">
                                <div class="ad-checkbox mr-2">
                                    <label>
									<input type="radio" name="user_type" class="ad-checkbox" value="agent">
									<span><?php echo $this->lang->line('ltr_agent');?></span>
									</label>
                                </div>
                                <div class="ad-checkbox">
                                    <label>
									<input type="radio" name="user_type" class="ad-checkbox" value="user">
									<span><?php echo $this->lang->line('ltr_user');?></span>
									</label>
                                </div>
                                </div>
                            </div>
                            <div class="ad-auth-form register_form">
								<div class="ad-auth-feilds mb-30">
                                    <input type="text" name="full_name" id="fullname" placeholder="<?php echo $this->lang->line('ltr_enter_name');?>" class="ad-input" />
                                ...
                                <div class="ad-auth-feilds mb-30">
                                    <input type="email" name="email" id="emailId" placeholder="<?php echo $this->lang->line('ltr_email');?>" class="ad-input" />
                                    <div class="ad-auth-icon">
                                ...
                                <div class="ad-auth-feilds mb-30">
                                    <input type="password" placeholder="<?php echo $this->lang->line('ltr_password');?>" class="ad-input" name="password" id="pass"/>
                                    <div class="ad-auth-icon">
                                    ...
                                    <small style="color:grey;">Password must contain uppercase, lowercase, special and numeric characters. Length 8 to 200</small>
                                </div>
                                <div class="ad-auth-feilds">
                                    <input type="hidden" id="rg_phone" name="rg_phone">
                                    <input  type="text" maxlength="15" oninput="this.value = this.value.replace(/[^+\d]+/g, '')"  placeholder="<?php echo $this->lang->line('ltr_phone_number');?> " class="ad-input " name="phone" id="phone_number"  minlength="7"/>
                                </div>
                            </div>
                            
                            <div class="ad-auth-btn">
                                <input type="submit" name="submit" class="ad-btn btn-block ad-login-member" value="<?php echo $this->lang->line('ltr_signup');?>">
                            </div>
                            <p class="ad-register-text"><?php echo $this->lang->line('ltr_login_text');?> <a class="primary"  href="<?=base_url()?>login"><?php echo $this->lang->line('ltr_login');?></a></p>
                        </form>
                    </div>
                </div>
            </div>
	...
	<script src="<?=base_url();?>assets/js/intlTelInput-jquery.min.js"></script>
