            ...
            <div class="main-content">
                    ...
                    <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-title-wrapper">
                            <div class="page-title-box">
                                <h4 class="page-title bold"><?php echo $this->lang->line('ltr_dashboard');?></h4>
                            </div>
                            <div class="breadcrumb-list">
                                <ul>
                                    <li class="breadcrumb-link">
                                        <a href="<?=base_url('admin');?>"><i class="fas fa-home mr-2"></i><?php echo $this->lang->line('ltr_dashboard');?></a>
                                    </li>
                                    <li class="breadcrumb-link active"><?php echo $this->lang->line('ltr_admin');?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title"><?php echo $this->lang->line('ltr_happy_customers');?></h5>
                                    <h4 class="ad-card-title"><?=$visiter;?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title"><?php echo $this->lang->line('ltr_active_properties');?></h5>
                                    <h4 class="ad-card-title"><?=$active_property;?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title"><?php echo $this->lang->line('ltr_inactive_properties');?></h5>
                                    <h4 class="ad-card-title"><?=$inactive_property;?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title"><?php echo $this->lang->line('ltr_queries');?></h5>
                                    <h4 class="ad-card-title"><?=$inquiry;?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        <div class="card chart-card">
                            <div class="card-header">
                                <h4 class="has-btn"><?php echo $this->lang->line('ltr_total_revenue');?><span></span></h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-8 col-lg-12 col-md-12">
                                        <div class="chart-holder">
                                            <input type="hidden" id="revenueData" value="<?=base64_encode(json_encode($revenue));?>">
                                            <div id="chartG"></div>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-12 col-md-12">
                                        <div class="revenue-wrapper">
                                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="tab1-tab" data-toggle="pill" href="#tab1" role="tab" aria-controls="tab1" aria-selected="true"><?php echo $this->lang->line('ltr_weekly');?></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab2-tab" data-toggle="pill" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"><?php echo $this->lang->line('ltr_monthly');?></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="tab3-tab" data-toggle="pill" href="#tab3" role="tab" aria-controls="tab3" aria-selected="false"><?php echo $this->lang->line('ltr_yearly');?></a>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                                                    <div class="revenue-info-wrap">
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td><i class="far fa-chart-bar mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_revenue');?></td>
                                                                    <td><?=$weekdata[0]['TotalRevenue']?$weekdata[0]['TotalRevenue']:0;?> <?=loop_select('id',loop_select('id',1,'currency','px_owner_company'),'currency_symbol','px_currencies');?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i class="fas fa-user-friends mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_subscription');?></td>
                                                                    <td><?=$weekdata?$weekdata[0]['TotalSubscription']:0;?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                                    <div class="revenue-info-wrap">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                    <td><i class="far fa-chart-bar mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_revenue');?></td>
                                                                    <td><?=$currentRevenue?$currentRevenue:0;?> <?=loop_select('id',loop_select('id',1,'currency','px_owner_company'),'currency_symbol','px_currencies');?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i class="fas fa-user-friends mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_subscription');?></td>
                                                                    <td><?=$currentsubscription?$currentsubscription:0;?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                                                    <div class="revenue-info-wrap">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                    <td><i class="far fa-chart-bar mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_revenue');?></td>
                                                                    <td><?=$totalrevenue[0]['TotalRevenue']?$totalrevenue[0]['TotalRevenue']:0;?> <?=loop_select('id',loop_select('id',1,'currency','px_owner_company'),'currency_symbol','px_currencies');?></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><i class="fas fa-user-friends mr-2 icon-only"></i><?php echo $this->lang->line('ltr_total_subscription');?></td>
                                                                    <td><?=$totalrevenue[0]['TotalSubscription']?$totalrevenue[0]['TotalSubscription']:0;?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card chart-card">
                            <div class="card-header">
                                <h4><?php echo $this->lang->line('ltr_newest_listings');?></h4>
                            </div>
                                        ...
                                        <table class="table table-styled mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo $this->lang->line('ltr_agent');?></th>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?=loop_select('id',$listrow['agent'],'full_name','px_userdata');?></td>
                                            ...
                                            <?php    ?>
                                               ...
                                               <span class="text-danger">Reject</span>
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <td>
                                                        <a href="<?=base_url();?>listing/<?=$listrow['id'];?>-<?=str_replace(",","-",$listrow['url_sluge']);?>"><label class="mb-0 badge badge-success" title="" data-original-title="Pending">View Detail</label></a>
                                                    </td>
                                                    ...
                                                    <td class="">
                                                        <div class="relative">
                                                            ...
                                                            <div class="action-option ">
                                                                <ul>
                                                                    <li>
                                                                    <a href="<?=base_url('admin/add-property')?>?pid=<?=$listrow['id'];?>"><i class="far fa-edit mr-2 getid"></i><?php echo $this->lang->line('ltr_edit');?></a>
                                                                    </li>
                                                                    <li>
