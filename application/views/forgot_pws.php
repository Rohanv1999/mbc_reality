            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form class="formget" method="post" action="<?=site_url('login/forgot-password-link')?>">
                            ...
                            <p><?php echo $this->lang->line('ltr_forget_pws_text');?></p>
                            <div class="ad-auth-form">
                                <div class="ad-auth-feilds mb-30">
                                    <input type="email" name="reset_email" placeholder="<?php echo $this->lang->line('ltr_email');?>" class="ad-input" />
                            ...
                            <div class="ad-auth-btn">
                                <input type="submit" name="submit" class="ad-btn btn-block ad-login-member" value="<?php echo $this->lang->line('ltr_send_password');?>">
                            </div>
                            <p class="ad-register-text"><?php echo $this->lang->line('ltr_login_text');?> <a class="primary" href="<?php echo base_url('login')?>"><?php echo $this->lang->line('ltr_login');?></a></p>
                        </form>
                    </div>
                </div>
            </div>
