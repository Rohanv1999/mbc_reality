                            ...
                            <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-box">
                                        <h4 class="page-title bold"><?php echo $this->lang->line('ltr_users');?></h4>
                                    </div>
                                    <div class="breadcrumb-list">
                                        <ul>
                                            ...
                                            <li class="breadcrumb-link active"><?php echo $this->lang->line('ltr_users');?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card table-card">
                                    <div class="card-header pb-0">
                                        <h4><?php echo $this->lang->line('ltr_users');?></h4>
                                        <div class="error"></div>
                                    </div>
                                    <div class="card-body pb-4">
                                        <div class="chart-holder">
                                            <div class="form-group">
                                                <a href="<?=base_url('admin/edit-team');?>" class="btn btn-primary squer-btn mt-2 mr-2 mb-2"><?php echo $this->lang->line('ltr_add_user');?></a>
                                            ...
                                            <table id="example" class="table table-striped table-bordered dt-responsive wrap data_table" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th>#</th>
                                                        <th><?php echo $this->lang->line('ltr_username');?></th>
                                                        <th><?php echo $this->lang->line('ltr_full_name');?></th>
                                                        <th><?php echo $this->lang->line('ltr_user_type');?></th>
                                                ...
                                                <?php
                                                $i=1;
                                                foreach($userdata as $listrow){
                                                ?>
                                                    <tr>
                                                        <td><input type="checkbox" class="selectUser" name="userIds" value="<?= $listrow['id'];?>"></td>
                                                        <td><?=$i;?></td>
                                                        <td><?=$listrow['user_name'];?></td>
                                                        <td><?=$listrow['full_name'];?></td>
                                                        <td><?=$listrow['user_type'];?></td>
                                                        <td>
														<label class="switch">
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary deletes" d_id="<?=$listrow['id'];?>" tables="px_userdata"><?php echo $this->lang->line('ltr_delete_yes_button');?></button>
                               ...
                               var userIds = [];
                                ...
                                if(userIds.length > 0){
                                    if($('#bulk-stts-chnge').val() =='delete'){
                                      ...
                                      $('#confirmModalMsg').text('Are you sure you want to deleted selected accounts?')
                                    }
                                    else if($('#bulk-stts-chnge').val() =='inactive'){  $('#confirmModalMsg').text('Are you sure you want to make selected accounts Inactive ?')
                                     $('#confirmOk').text('Yes')
                                    }
                                    else{
                                        $('#confirmModalMsg').text('Are you sure you want to make selected accounts Active ?')
                                         $('#confirmOk').text('Yes')
                                    }
                                    ...
                                    $.ajax({
                                     ...
                                     showAlert('No user or agent selected.', 'error', $('#burl').val());
                                }
