        ...
        <header class="header-wrapper main-header">
            <div class="header-inner-wrapper">
                <div class="header-right">
                    ...
                    <a href="<?=base_url();?>" target="_blank"><?php echo $this->lang->line('ltr_visit_website');?></a>
                        <div class="user-info-wrapper header-links">
                            ...
                            <div class="user-info-box">
                                <div class="drop-down-header">
                                    <h4><?=loop_select('id',$_SESSION['id'],'full_name','px_userdata');?></h4>
                                    <p><?=loop_select('id',$_SESSION['id'],'user_type','px_userdata');?></p>
                                </div>
                                <ul>
                                    <li>
                                        <a href="<?=base_url('agent/profile');?>">
                                            <i class="far fa-edit"></i>
                                            <?php echo $this->lang->line('ltr_edit_profile');?>
                                        </a>
                                    </li>
                                    <li>
