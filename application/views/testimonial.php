                                ...
                                <div class="page-title-wrapper">
                                    ...
                                    <div class="breadcrumb-list">
                                        ...
                                        <ul>
                                            ...
                                            <li class="breadcrumb-link"><?php echo $this->lang->line('ltr_testimonials');?></li>
                                ...
                                <div class="card table-card">
                                    ...
                                    <div class="card-body pb-4">
                                        ...
                                        <div class="chart-holder">
                                            ...
                                            <a href="<?=base_url('admin/edit-testimonial');?>" class="btn btn-primary squer-btn mt-2 mr-2 mb-2"><?php echo $this->lang->line('ltr_add_testimonial');?></a>
                                            ...
                                            <table id="example" class="table table-striped table-bordered dt-responsive wrap data_table" style="width:100%">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><?php echo $this->lang->line('ltr_client_image');?></th>

                                                        <th><?php echo $this->lang->line('ltr_client_name');?></th>

                                                        <th><?php echo $this->lang->line('ltr_client_designation');?></th>

                                                        <th><?php echo $this->lang->line('ltr_client_say');?></th>
                                                ...
                                                foreach($testimonial_data as $listrow){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="img-thumb ">
                                                                ...
                                                                <img width="93" height="93" src="<?=base_url().'uploads/'.$listrow['client_image'];?>" alt=" ">

                                                            </span>

                                                        </td>

                                                        <td><?=$listrow['client_name'];?></td>

                                                        <td><?=$listrow['post'];?></td>

                                                        <td><?=$listrow['testimonial'];?></td>

                                                        <td>

														<label class="switch">
                                                        <input id="testimonials_status<?=$listrow['id'];?>" class="switch_button" rowid="<?=$listrow['id'];?>" tables="px_testimonial" type="checkbox" <?php if(isset($listrow['status']) && $listrow['status']=="1") { echo "checked"; } ?>>
                                                            ...
                                                            <div class="relative">
                                                                ...
                                                                <div class="action-option">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <a href="<?=base_url('admin/edit-testimonial')?>?tid=<?=$listrow['id'];?>"><i class="far fa-edit mr-2 getid"></i><?php echo $this->lang->line('ltr_edit');?></a>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary deletes" d_id="<?=$listrow['id'];?>" tables="px_testimonial"><?php echo $this->lang->line('ltr_delete_yes_button');?></button>
