                            ...
                            <div class="colxl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-title-wrapper">
                                    <div class="page-title-box">
                                        <h4 class="page-title bold"><?php echo $this->lang->line('ltr_category');?></h4>
                                    </div>
                                    <div class="breadcrumb-list">
                                        <ul>
                                            ...
                                            <li class="breadcrumb-link active"><?php echo $this->lang->line('ltr_add_category');?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card table-card">
                                    <div class="card-header pb-0">
                                        <h4><?php echo $this->lang->line('ltr_add_category');?></h4>
										<div class="error"></div>
                                    </div>
                                    <div class="card-body pb-4">
                                        <div class="chart-holder">
                                            <form class="separate-form formget" method="POST" action="<?=base_url('admin/addcategory');?>">
                                                <input type="hidden" name="update_id" value="<?=(isset($update_category[0]['id']) && !empty($update_category[0]['id']))?$update_category[0]['id']:'';?>">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                <label for="category" class="col-form-label"><?php echo $this->lang->line('ltr_category_name');?></label>
                                                                <input class="form-control" type="text" placeholder="<?php echo $this->lang->line('ltr_category_name');?>" id="category"name="category" value="<?=(isset($update_category[0]['category']) && !empty($update_category[0]['category']))?$update_category[0]['category']:'';?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="action-btns" style="display:inline; ">
                                                <select name="change-cat-stts" id="bulk-stts-chnge">
                                            ...
                                            <table id="example" class="table table-striped table-bordered dt-responsive wrap data_table" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th>#</th>
                                                        <th><?php echo $this->lang->line('ltr_category_name');?></th>
                                                ...
                                                <?php
                                                $i=1;
                                                foreach($category_table as $listrow){
                                                ?>
                                                    <tr>
                                                     <td><input type="checkbox" class="selectCategories" name="catIds" value="<?= $listrow['id'];?>"></td>
                                                     
                                                        <td><?=$i;?></td>
                                                        <td><?=$listrow['category'];?></td>
                                                        <td>
                                                        <label class="switch">
                                                        <input id="category_status<?=$listrow['id'];?>" class="switch_button" rowid="<?=$listrow['id'];?>" tables="px_addcategory" type="checkbox" <?php if(isset($listrow['status']) && $listrow['status']=="1") { echo "checked"; } ?>>
                                                        ...
                                                        <td class="">
                                                            <div class="relative">
                                                                ...
                                                                <div class="action-option ">
                                                                    <ul>
                                                                        <li>
                                                                            <a href="<?=base_url('admin/categories')?>?cid=<?=$listrow['id'];?>"><i class="far fa-edit mr-2 getid"></i><?php echo $this->lang->line('ltr_edit');?></a>
                                                                        </li>
                                                                        <li>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary deletes" d_id="<?=$listrow['id'];?>" tables="px_addcategory"><?php echo $this->lang->line('ltr_delete_yes_button');?></button>
                           ...
                           $('#changeStatus').on('click', function(){
                               ...
                               var catIds = [];
                                ...
                                if(catIds.length > 0){
                                    ...
                                    else if($('#bulk-stts-chnge').val() =='inactive'){  $('#confirmModalMsg').text('Are you sure you want to make selected categories Inactive ?')
                                     $('#confirmOk').text('Yes')
                                    }
                                    else{
