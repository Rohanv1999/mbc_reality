                            ...
                            <div class="breadcrumb-list">
                                <ul>
                                    <li class="breadcrumb-link">
                                        <a href="<?=base_url('agent');?>"><i class="fas fa-home mr-2"></i><?php echo $this->lang->line('ltr_dashboard');?></a>
                                    </li>
                                    <li class="breadcrumb-link active"><?php echo $this->lang->line('ltr_agent');?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title"><?php echo $this->lang->line('ltr_property_listed');?></h5>
                                    <h4 class="ad-card-title"><?=row_count('agent',$this->session->userdata('id'),'px_properties');?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-styled mb-0">
                                            <thead>
                                                <tr>
													...
													<th><?php echo $this->lang->line('ltr_purpose');?></th>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label class="mb-0 badge badge-info" title="" data-original-title="Pending"><?=loop_select('id',$listrow['purpose'],'purpose','px_addpurpose');?></label>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="">
                                                    <?php if($listrow['uploaded_by']=='agent'){ ?>
                                                        <div class="relative">
                                                            ...
                                                            <div class="action-option ">
                                                                <ul>
                                                                    <li>
                                                                    <a href="<?=base_url('agent/add-property')?>?pid=<?=$listrow['id'];?>"><i class="far fa-edit mr-2 getid"></i><?php echo $this->lang->line('ltr_edit');?></a>
                                                                    </li>
                                                                    <li>
