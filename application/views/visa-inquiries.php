                                            ...
                                            <table id="example" class="table table-striped table-bordered dt-responsive wrap data_table" style="width:100%">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?=$i;?></td>
                                                        <td><?=$listrow['date_time'];?></td>
                                                        <td><?=$listrow['email'];?></td>
                                                        <td><?=$listrow['msg'];?></td>
                                                        <td><?=$listrow['mobile'];?></td>
                                                        
                                                        <td><?=$listrow['visa_type'];?></td>
                                                                ...
                                                                <div class="action-option ">
                                                                    <ul>
                                                                     <?php
                                                                        ...
                                                                        <li>
                                                                            <a href="<?= base_url('admin/getUrl/'.$listrow['email']) ?>"><i class="far fa-edit mr-2"></i><?php echo $this->lang->line('ltr_reply');?></a>
                                                                        </li>
                                                                        <?php }else{ ?>
                                                                         <li>
                                                                            <a href="mailto:<?=$listrow['email'];?>"><i class="far fa-edit mr-2"></i><?php echo $this->lang->line('ltr_reply');?></a>
                                                                        </li>
                                                                        <?php } ?>
                                                                        <li>
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary deletes" d_id="<?=$listrow['id'];?>" tables="px_visa_queries"><?php echo $this->lang->line('ltr_delete_yes_button');?></button>
                           ...
                           $('#changeStatus').on('click', function(){
                               ...
                               var inqIds = [];
                                ...
                                if(inqIds.length > 0){
                                    ...
                                    $.ajax({
                                        url: "<?= base_url('Admin/deleteVisaInquiry'); ?>",
                                        type: 'POST',
                                        data:{
                                            inqIds : inqIds,
